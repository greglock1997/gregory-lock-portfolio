...
function Contact(): JSX.Element {
  return (
    <div className="w-full flex flex-col items-center gap-y-8 py-32 container bg-[#A388EE] px-12">
        <h1 className="text-white font-bold font-title text-3xl md:text-6xl">Contact</h1>
