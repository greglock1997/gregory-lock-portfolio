  ...
  return (
    <div className='w-full flex flex-col items-center gap-y-16 py-32 container bg-[#87CEEB] px-12'>
      <div className="flex flex-col gap-y-2 md:gap-y-4 bg-white md:max-w-2/3 p-4 md:p-8 border-4 border-black shadow-[12px_12px_0_0_rgba(0,0,0,1)]">
        ...
        <p className="text-black font-bold font-title md:text-xl">A selection of personal projects built to explore and apply ideas learned through independent study.</p>
      </div>
